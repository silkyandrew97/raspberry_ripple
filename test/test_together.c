...
jack_port_t *output_port_7;
jack_port_t *output_port_8;
...
static inline void print_help(){
    printf("\n"
           "Usage:\n"
           "  test_together [Additional Arguments]\n"
           "\n"
...
int process (jack_nframes_t nframes, void *arg){
    ...
    jack_default_audio_sample_t *in, *out_1, *out_2, *out_3, *out_4, *out_5, *out_6, *out_7, *out_8;
    ...
    //out_7 Timer Calculations
    timer_calcs(timer.t7, begin, end);
    ...
    //out_8 Timer Calculations
    timer_calcs(timer.t8, begin, end);
...
int main (int argc, char *argv[]){
    ...
    output_port_6 = jack_port_register (client, "output_6",
                      JACK_DEFAULT_AUDIO_TYPE,
                      JackPortIsOutput, 0);
    output_port_7 = jack_port_register (client, "output_7",
                      JACK_DEFAULT_AUDIO_TYPE,
                      JackPortIsOutput, 0);
    output_port_8 = jack_port_register (client, "output_8",
                      JACK_DEFAULT_AUDIO_TYPE,
                      JackPortIsOutput, 0);
    ...
    if ((input_port == NULL) || (output_port_1 == NULL) ||
        ...
        (output_port_6 == NULL) || (output_port_7 == NULL) ||
        (output_port_8 == NULL)) {
